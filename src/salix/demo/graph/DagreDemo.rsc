module salix::demo::graph::DagreDemo
...
App[GModel] graphApp()
  = app(ginit, gview, gupdate, |http://localhost:9104|, |project://salix-figure/src|);
...
void gview(GModel m) {
  div(() {
    ...
    dagre("mygraph", rankdir("LR"), salix::SVG::width("1966px"), salix::SVG::height("600px"), (N n, E e) {
